...
class AddCustomer:
    ...
    txtNewsletter_xpath="//div[@k-widget k-multiselect k-multiselect-clearable]"
    ...
    def setCustomerRoles(self,role):
        ...
        if role == 'Registered':
            ...
            #self.driver.find_element_by_xpath("//*[@id='SelectedCustomerRoleIds_taglist']/li[@class='k-button']/span[@class='k-select']").click()
